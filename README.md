# ICS344 Course Project – Attack & Defense

This project demonstrates an end-to-end security scenario using Kali Linux (attacker) and Metasploitable3 (victim).

## Phases:
- **Phase 1**: Brute-force SSH using Hydra + Nmap scan
